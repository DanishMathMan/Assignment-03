...
const file_proto_proto_rawDesc = "" +
	...
	"\aConnect\x12\t.UserName\x1a\b.Process\x12\x1e\n" +
	"\n" +
	"Disconnect\x12\b.Process\x1a\x06.Empty\x12&\n" +
	"\x04Chat\x12\f.ChatMessage\x1a\f.ChatMessage(\x010\x01B\x1aZ\x18Assignment-03/grpc/protob\x06proto3"
...
var file_proto_proto_depIdxs = []int32{
	...
	1, // 1: ChitChatService.Disconnect:input_type -> Process
	0, // 2: ChitChatService.Chat:input_type -> ChatMessage
	1, // 3: ChitChatService.Connect:output_type -> Process
	3, // 4: ChitChatService.Disconnect:output_type -> Empty
	0, // 5: ChitChatService.Chat:output_type -> ChatMessage
